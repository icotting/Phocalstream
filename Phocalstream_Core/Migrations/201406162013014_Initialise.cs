    ...
    public partial class Initialise : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        Photo_ID = c.Long(nullable: false),
                        Tag_ID = c.Long(nullable: false),
                    })
                .PrimaryKey(t => new { t.Photo_ID, t.Tag_ID })
                .ForeignKey("dbo.Photos", t => t.Photo_ID, cascadeDelete: true)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.PhotoTags", "Tag_ID", "dbo.Tags");
            DropForeignKey("dbo.PhotoTags", "Photo_ID", "dbo.Photos");
